...
a||this};b.Vivifier.prototype.constructor=b.Vivifier;b.Vivifier.prototype.vivify=function(a){var c=this;if(!a)throw Error("Invalid element type!");a.attributes["syload"]&&(a.attributes["syload"].value.match(":")?a=this.addListeners(a,"syload"):a.addEventListener("click",function(){c.instance.render(a.attributes["syload"].value+b.FILETYPE)}));return a};b.Vivifier.prototype.addListeners=function(a,c){var d=this,e=a.attributes[c].value.split(":");if(2<=e[0].split("&").length)for(var e=e[0].match("&")?

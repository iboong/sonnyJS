...
b.StorageManager.prototype.constructor=b.StorageManager;b.StorageManager.prototype.init=function(){var a=this;this.synchronize();this.StorageName=b.STORAGE_EXT+"Instance::"+(new Date).getTime();localStorage[this.StorageName]||localStorage.setItem(this.StorageName,JSON.stringify(this.EmptyStorageTemplate));this.Storage=JSON.parse(localStorage[this.StorageName]);for(var c in localStorage)c.match(b.STORAGE_EXT+"Instance::")&&c!==a.StorageName&&localStorage.removeItem(c);window.addEventListener("beforeunload",
function(){localStorage.removeItem(a.StorageName)});window.addEventListener("storage",function(b){a.countWindows();localStorage[a.StorageName]||localStorage.setItem(a.StorageName,JSON.stringify(a.Storage));a.synchronize()})};b.StorageManager.prototype.onupdate=function(a){var c={};window.addEventListener("storage",function(){for(var d in localStorage)d.match(b.STORAGE_EXT)&&!d.match(b.STORAGE_EXT+"Instance")&&(c[d.split("::")[1]]=localStorage[d],a(c))})};b.StorageManager.prototype.keyExists=function(a){return this.__instance.GLOBALKEYS[a]||
